...
namespace ServiceImplementation.AdsServices.Gads
{
    ...
    public class GadsmeWrapper : IInitializable, INativeAdsService
    {
        ...
        public void Initialize()
        {
            ...
            this.SetCurrentEventSystem().Forget();
        }

        private async UniTaskVoid SetCurrentEventSystem()
        {
            await UniTask.WaitUntil(() => GadsmeSDK.IsInitialized && this.eventSystem);
            GadsmeSDK.SetEventSystem(this.eventSystem);
        }
